...
create table nguoi_dung(
    ...
    dia_chi varchar(255),
    vai_tro enum('khach_hang', 'nhan_vien', 'quan_tri_vien') not null default 'khach_hang',
...
create table su_kien(
    ...
    trang_thai enum('ban_nhap','cho_duyet', 'da_duyet', 'da_huy') default 'cho_duyet',
    ngay_tao timestamp default current_timestamp,
    ngay_cap_nhat timestamp default current_timestamp on update current_timestamp,
...
create table don_hang(
    ...
    trang_thai_thanh_toan enum('cho_thanh_toan','da_thanh_toan', 'that_bai', 'da_huy') default 'cho_thanh_toan',
    trang_thai_don_hang enum('cho_xac_nhan','da_xac_nhan', 'da_huy') default 'cho_xac_nhan',
    ngay_tao timestamp default current_timestamp,
    ngay_cap_nhat timestamp default current_timestamp on update current_timestamp,
...
create table xac_nhan_ve(
    ...
    trang_thai enum('hop_le','da_su_dung', 'khong_hop_le') default 'hop_le',
    constraint fk_xac_nhan_chi_tiet foreign key(ma_chi_tiet) references chi_tiet_don_hang(ma_chi_tiet),
