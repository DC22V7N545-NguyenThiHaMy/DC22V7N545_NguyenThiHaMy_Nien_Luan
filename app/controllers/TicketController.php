...
class TicketController
{
    ...
    private function sendSepayRequest(string $url, array $body): array
    {
        $ch = curl_init($url);
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER, [
            ...
            'X-SECRET-KEY: ' . (string)SEPAY_SECRET_KEY,
        ]);
    ...
    private function signSepayFields(array $fields, string $secretKey): string
    {
        $allowed = [
            'merchant',
            'operation',
        ...
        return base64_encode(hash_hmac('sha256', implode(',', $pairs), $secretKey, true));
    }
}
